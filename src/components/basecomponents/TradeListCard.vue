<template>
  <router-link
    ...
    exact-active-class=""
  >
    <div class="flex gap-2 md:gap-3 w-6/12">
      <div class="flex">
    ...
    <div class="text-xs md:text-sm text-Grayscale-Grey-3 w-3/12 flex md:flex-row flex-col justify-end items-end">
      <span class="text-Black-and-White-Black pr-1 md:pr-2">$ 1.01</span>
    </div>
    <div class="flex gap-2 md:gap-6 w-3/12 justify-end items-center">
      <!----><div class="text-xs md:text-sm text-Grayscale-Grey-3 flex md:flex-row flex-col items-center"><span class="text-Color-Code-Green pl-2">+0.5%</span></div>
